...
using UserManagementWebIdentity.ViewModels;

namespace UserManagementWebIdentity.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Add()
        {
            var roles = await _roleManager.Roles
                .Select(r => new RoleViewModel { RoleId = r.Id, RoleName = r.Name }).ToListAsync();
        ...
        public async Task<IActionResult> Edit(ProfileFormViewModel model)
        {
            ...
            var userWithSameUserName = await _userManager.FindByNameAsync(model.UserName.Trim());
